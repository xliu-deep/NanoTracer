...
def plot_contour_1(): 
	...
	cs = plt.contourf(xx, yy, Z,cmap=cmap, alpha=0.1)
...
def plot_contour_2(): 
	...
	from matplotlib.colors import LinearSegmentedColormap
	cmap = LinearSegmentedColormap.from_list('mylist', ['#3380FF', '#80BEE7'], N=2)
	cs = plt.contourf(xx, yy, Z, cmap=cmap, alpha=0.25)
...
def plot_contour_3_mgh(): 
	...
	Z = Z.reshape(xx.shape)
	from matplotlib.colors import LinearSegmentedColormap
	cmap = LinearSegmentedColormap.from_list('mylist', ['#0099FF','#00CC66'], N=2)
...
def plot_contour_3_mag():
	...
	Z = Z.reshape(xx.shape)
	from matplotlib.colors import LinearSegmentedColormap
	cmap = LinearSegmentedColormap.from_list('mylist', ['#0099FF','#00CC66','#A266FF'], N=3)
	cs = plt.contourf(xx, yy, Z, cmap=cmap, alpha=0.25)
